 ...
 */
void PointcloudToOcgrid::convertPointcloudToOcgrid(PointCloud::Ptr pointcloudPtr, nav_msgs::OccupancyGrid &ocgrid, int inflation, bool skeletonisation, int minClusterSize) 
{
    ...
    if(inflation > 0) inflate(ocgrid, inflation);
    if(skeletonisation) skelotonise(ocgrid);
 ...
 * @param[out] ocgrid   Occupany Grid for output pointcloud, also used for MapMetaData
 */
void PointcloudToOcgrid::pointsToOcgrid(PointCloud::Ptr pointcloudPtr, nav_msgs::OccupancyGrid &ocgrid) {
 ...
 */
void PointcloudToOcgrid::inflate(nav_msgs::OccupancyGrid &ocgrid, int inflation) {
 ...
 * @param[in,out] ocgrid   Occupany Grid for output pointcloud, also used for MapMetaData
 */
void PointcloudToOcgrid::skelotonise(nav_msgs::OccupancyGrid &ocgrid) {
 ...
 * @param[in,out] ocgrid   Occupany Grid for output pointcloud, also used for MapMetaData
 */
void PointcloudToOcgrid::filterClusters(nav_msgs::OccupancyGrid &ocgrid, int minClusterSize) {
 ...
 * @param[in,out] ocgrid   Occupany Grid for output pointcloud, also used for MapMetaData
 */
void PointcloudToOcgrid::raytrace(nav_msgs::OccupancyGrid &ocgrid) {
    // Ray Tracing
